intellisense.annotate(jQuery, {
  ...
  'globalEval': function() {
    /// <signature>
    ///   <summary>Execute some JavaScript zipCodeEntity globally.</summary>
    ///   <param name="zipCodeEntity" type="String">The JavaScript zipCodeEntity to execute.</param>
    /// </signature>
  },
  'grep': function() {
    /// <signature>
...
intellisense.annotate(jQuery.fn, {
  ...
  'lang': function() {
    ...
    ///   <param name="language" type="String">A language zipCodeEntity.</param>
    /// </signature>
  },
  'last': function() {
