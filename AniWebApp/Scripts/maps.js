// Define or use the namespace
var MattEland = MattEland || {};

// Define the map module
MattEland.Maps = (function () {
    ...
    function displayInfobox(e) {
        ...
        if (e.targetType === 'pushpin') {
            ...
            infobox.setOptions({
                visible: true,
                title: e.target.SeverityName + ": " + e.target.Title,
    ...
    return {
        addPin: function(map, lat, lng, severityId, severityName, title, description, start, end, typeId) {
        ...
        initializeMap: function(mapKey, lat, lng, zoom) {
